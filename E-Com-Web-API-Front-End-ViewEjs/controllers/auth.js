      ...
      return bcrypt
        ...
        .then((result) => {
          ...
          return transporter.sendMail({
            ...
            html: `<h1>congratulations <strong> ${userName}  </strong> Welcome To ShopBaba.. </h1>
                 <p>Enjoy shopping @ Shopbaba....!</p>
                 <p>Your Email is: <strong> ${email} </strong></p>
                 <p>Your Bank Account is:  <strong> ${bankAcc} </strong><</p>
                 <p>Your Bank Balance is  <strong> ${balance} </strong></p>
                 `,
          });
        })
        .catch((err) => {
